...
public final class HttpMessage {
	 ...
	 * server.
     *
     * Be aware this is not a secure thing to do, but it's quick an easy
     * for a variety of reasons.
	 */
	public static void setAllowAllHostnameVerified() throws Exception {
